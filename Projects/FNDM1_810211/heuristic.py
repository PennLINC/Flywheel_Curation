### This heuristic organizes FNDM1 (810211) data on Flywheel
###
### Ellyn Butler
### September 17, 2019
...
def gather_session_indeces():
    ...
    cs = fw.projects.find_first('label="{}"'.format("FNDM1_810211"))
    ...
    for x in range(len(cs_subjects)):
        ...
        if sess_list:
            ...
            for i, y in enumerate(sess_list):
                sess_dict[y.label] = "FNDM1" + str(i + 1) #!!!!!!!!
...
def infotodict(seqinfo):
    ...
    for s in seqinfo:
        ...
        # t1
        if "mprage" in protocol and 'nav' not in protocol and s.TR == 1.81 and s.dim1 == 256: #need to clear BIDS for this to work
